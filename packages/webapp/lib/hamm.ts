// Generated by @wagmi/cli@1.0.0 on 17/05/2023 at 09:15:21
import {
  useContractRead,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link hammABI}__ and `functionName` set to `"calculateTip"`.
 */
export function useHammCalculateTip<
  TFunctionName extends 'calculateTip',
  TSelectData = ReadContractResult<typeof hammABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof hammABI, TFunctionName, TSelectData>,
